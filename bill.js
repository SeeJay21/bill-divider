...
function showCalculatedOutput(input) {
    ...
    document.getElementById('total-bill').innerHTML = `R ${totalAmount.toFixed(2)}`;
    document.getElementById('bill-per-person').innerHTML = `R ${billPerPerson.toFixed(2)}`;
    document.getElementById('total-tip').innerHTML = `R ${totalTip.toFixed(2)}`;
    document.getElementById('tip-per-person').innerHTML = `R ${tipPerPerson.toFixed(2)}`;
}